        ...
        Padding(
          ...
          child: Stack(
            children: <Widget>[
              CircleAvatar(
                radius: 70,
                child: ClipOval(child: Image.asset('assets/images/default.jpg', height: 150, width: 150, fit: BoxFit.cover,),),
              ),
        ...
        Expanded(child: Container(
          decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                  ...
                  colors: [Colors.green, Color.fromRGBO(11, 156, 49, 0.2)]
              )
          ),
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text('IC number', style: TextStyle(color: Colors.white70),),
                    ),
                  ), decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.white70)),
                ),
              ),
